...
import 'route5_model.dart';
export 'route5_model.dart';

class Route5Widget extends StatefulWidget {
  const Route5Widget({Key? key}) : super(key: key);

  @override
  _Route5WidgetState createState() => _Route5WidgetState();
}

class _Route5WidgetState extends State<Route5Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Route5Model());
  }
                                    ...
                                    children: [
                                      Expanded(
                                        child: ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/unsplash_OihZAyTkj14.png',
                                            width: double.infinity,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/unsplash_qJ4xIwFJVWY_1.png',
                                            width: double.infinity,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/unsplash_t6sh0s1iYik.png',
                                            width: double.infinity,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                        ...
                                        children: [
                                          Expanded(
                                            child: ClipRRect(
                                              ...
                                              child: Image.asset(
                                                'assets/images/unsplash_djZrvWpPxpo.png',
                                                width: double.infinity,
                                                fit: BoxFit.cover,
                                              ),
                                            ),
