...
import 'course_open_model.dart';
export 'course_open_model.dart';

class CourseOpenWidget extends StatefulWidget {
  const CourseOpenWidget({Key? key}) : super(key: key);

  @override
  _CourseOpenWidgetState createState() => _CourseOpenWidgetState();
}

class _CourseOpenWidgetState extends State<CourseOpenWidget> {
  late CourseOpenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CourseOpenModel());
  }
